            ...
            <div class="row">
                <div class="col-md-6">
                  <div class="col-half">
                    <label for="expense-type" class="bold-label">Type de dépense</label>
                      <select required class="form-control blue-border" data-testid="expense-type" default="Transports">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="number" class="form-control blue-border" data-testid="amount" placeholder="348" />
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" class="form-control blue-border" id="file" />
                  </div>
                </div>
            </div>
            <div class="row">
