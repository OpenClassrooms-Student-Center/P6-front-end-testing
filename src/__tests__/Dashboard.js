...
//   })
  ...
  describe('When I am on Dashboard page and I click on arrow', () => {
    test('Then, tickets list should be unfolding, and cars should contain first and lastname', async () => {
      ...
      const html = DashboardUI({ data: bills.data })
   
      document.body.innerHTML = html

      const handleShowTickets1 = jest.fn((e) => dashboard.handleShowTickets(e, bills.data, 1)) 
      const handleShowTickets2 = jest.fn((e) => dashboard.handleShowTickets(e, bills.data, 2))    
      const handleShowTickets3 = jest.fn((e) => dashboard.handleShowTickets(e, bills.data, 3))    
